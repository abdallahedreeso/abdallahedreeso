...
export function TopBar() {
  ...
  return (
    <header className="h-9 w-full bg-zinc-950/80 backdrop-blur-md border-b border-white/10 px-4 flex items-center justify-between text-xs text-zinc-300 z-40 select-none">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-1.5 text-zinc-400 border-l border-white/10 pl-3">
      ...
      <div className="hidden md:flex items-center gap-2 text-zinc-300 font-medium">
        {activeWindow ? (
          <div className="flex items-center gap-1.5 bg-white/5 border border-white/10 px-2.5 py-0.5 rounded-full text-[11px]">
            <span className="w-1.5 h-1.5 rounded-full bg-cyan-400" />
            <span>{activeWindow.title}</span>
          </div>
        ) : (
          <span className="text-zinc-500 text-[11px] font-mono">Desktop Active</span>
        )}
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="text-[11px] font-mono text-zinc-200 border-l border-white/10 pl-3">
          {timeStr || "12:00 PM"}
        </div>
