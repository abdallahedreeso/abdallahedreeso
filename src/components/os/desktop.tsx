...
export function DesktopWorkspace() {
  ...
  return (
    <div className="w-screen h-screen relative overflow-hidden bg-[#030712] text-zinc-100 flex flex-col select-none">
      ...
      <main className="flex-1 relative overflow-hidden w-full h-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-6 z-0 pointer-events-none">
          <motion.div
            ...
            className="pointer-events-auto max-w-2xl w-full p-8 rounded-3xl bg-zinc-950/40 backdrop-blur-md border border-white/10 shadow-2xl text-center space-y-6"
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-white">
              Abdallah <span className="bg-gradient-to-r from-cyan-400 via-sky-400 to-blue-500 bg-clip-text text-transparent">Edrees</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              <Button
                ...
                className="bg-cyan-500/15 hover:bg-cyan-500/25 border border-cyan-500/40 text-cyan-300 text-xs gap-2"
              >
              ...
              <Button
                ...
                className="bg-white/5 hover:bg-white/10 border border-white/15 text-zinc-200 text-xs gap-2"
              >
        ...
        <AnimatePresence>
          {openWindowIds.map((id) => (
            <OSWindowFrame key={id} id={id}>
              <Suspense fallback={<WindowLoader title={windows[id].title} />}>
                {id === "hero" && <HeroSection />}
