...
import { Box, Sparkles, Layers, Cpu, Code2, Database, Shield, Zap, Wrench, Globe } from "lucide-react";
...
export const InventoryGrid: React.FC = () => {
  ...
  return (
    <section id="inventory" className="w-full max-w-6xl mx-auto h-full flex flex-col justify-center px-4 py-2 overflow-y-auto">
      <div className="pixel-box-emerald p-3 sm:p-4 mb-4 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3">
          <Box className="w-6 h-6 text-emerald-400" />
          <h2 className="font-pixel text-base sm:text-xl text-emerald-400 pixel-text-shadow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 overflow-y-auto">
        {/* Left Grid of Pixel Slots */}
        <div className="lg:col-span-6 pixel-box p-3 sm:p-4 space-y-3">
          <p className="font-pixel text-[10px] text-slate-400 border-b border-slate-800 pb-2 flex items-center gap-2">
            ...
            {INVENTORY_ITEMS.map((item) => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={() => handleItemSelect(item)}
                ...
                >
                  ...
                  <span className="font-dialogue text-xs text-center text-slate-200 line-clamp-1">
                    {item.name.split(" ")[0]}
                  </span>
                </div>
              );
        ...
        <div className="lg:col-span-6">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="pixel-box-gold p-4 sm:p-5 space-y-3 h-full flex flex-col justify-between"
            >
              <div>
                {/* Header */}
                <div className="flex items-center justify-between border-b-2 border-slate-800 pb-2 mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-pixel text-xs sm:text-sm text-slate-100">
                        {activeItem.name}
                      </h3>
                    </div>
                  </div>
                ...
                {/* Stat Bonus Badge */}
                <div className="pixel-box bg-slate-950 p-2.5 mb-3 flex items-center gap-2">
                ...
                {/* Lore / Description */}
                <div className="bg-slate-950 p-3.5 border-2 border-amber-900/60 font-dialogue text-lg sm:text-xl text-slate-200 leading-relaxed">
                  {activeItem.description}
                </div>
              </div>

              {/* Item Metadata Footer */}
              <div className="pt-3 border-t border-slate-800 flex justify-between font-pixel text-[9px] text-slate-400">
